...
Continue work in `erniesg/tong` from local branch `codex/shanghai-portability-20260422-demo-smoke` at commit `e4aa879` (`wip: realign shanghai onboarding flow`), which is on top of `origin/codex/shanghai-integration-20260422`.
