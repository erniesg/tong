...
2. Demo password: `TONG-DEMO-ACCESS`

Override example:

```bash
TONG_DEMO_PASSWORD=MY_TEAM_PASSWORD TONG_SERVER_PORT=8787 TONG_CLIENT_PORT=3000 npm run demo:start
```
...
- `http://localhost:3000/?demo=TONG-DEMO-ACCESS`
- `http://localhost:3000/overlay?demo=TONG-DEMO-ACCESS`
- `http://localhost:3000/game?demo=TONG-DEMO-ACCESS`
- `http://localhost:3000/insights?demo=TONG-DEMO-ACCESS`
