...
const VOCAB_TRANSLATIONS: Record<string, Record<UILang, string>> = {
  ...
  'ㄱ': { en: 'g/k', zh: 'g — 像"哥"的声母', ja: 'g — 「が」の子音', ko: 'ㄱ' },
  'ㄴ': { en: 'n', zh: 'n — 像"呢"的声母', ja: 'n — 「な」の子音', ko: 'ㄴ' },
  'ㄷ': { en: 'd/t', zh: 'd — 像"的"的声母', ja: 'd — 「だ」の子音', ko: 'ㄷ' },
  'ㄹ': { en: 'r/l', zh: 'r/l — 像"了"的声母', ja: 'r/l — 「ら」の子音', ko: 'ㄹ' },
  'ㅁ': { en: 'm', zh: 'm — 像"么"的声母', ja: 'm — 「ま」の子音', ko: 'ㅁ' },
  'ㅂ': { en: 'b/p', zh: 'b/p — 像"八"的声母', ja: 'b/p — 「ば」の子音', ko: 'ㅂ' },
  'ㅅ': { en: 's', zh: 's — 像"四"的声母', ja: 's — 「さ」の子音', ko: 'ㅅ' },
  'ㅇ': { en: 'ng (silent)', zh: 'ng — 像"嗯"的鼻音', ja: 'ng — 「ん」の音', ko: 'ㅇ' },
  'ㅈ': { en: 'j', zh: 'j — 像"吉"的声母', ja: 'j — 「じゃ」の子音', ko: 'ㅈ' },
  'ㅊ': { en: 'ch', zh: 'ch — 像"吃"的声母', ja: 'ch — 「ちゃ」の子音', ko: 'ㅊ' },
  'ㅋ': { en: 'k', zh: 'k — 像"可"的声母', ja: 'k — 「か」の子音', ko: 'ㅋ' },
  'ㅌ': { en: 't', zh: 't — 像"他"的声母', ja: 't — 「た」の子音', ko: 'ㅌ' },
  'ㅍ': { en: 'p', zh: 'p — 像"怕"的声母', ja: 'p — 「ぱ」の子音', ko: 'ㅍ' },
  'ㅎ': { en: 'h', zh: 'h — 像"哈"的声母', ja: 'h — 「は」の子音', ko: 'ㅎ' },

  // ── Jamo vowel descriptions ──
  'ㅏ': { en: 'a', zh: 'a — 像"啊"', ja: 'a — 「あ」の音', ko: 'ㅏ' },
  'ㅑ': { en: 'ya', zh: 'ya — 像"呀"', ja: 'ya — 「や」の音', ko: 'ㅑ' },
  'ㅓ': { en: 'eo', zh: 'eo — 像"哦"', ja: 'eo — 「お」に近い音', ko: 'ㅓ' },
  'ㅕ': { en: 'yeo', zh: 'yeo — 像"哟"', ja: 'yeo — 「よ」に近い音', ko: 'ㅕ' },
  'ㅗ': { en: 'o', zh: 'o — 像"喔"', ja: 'o — 「お」の音', ko: 'ㅗ' },
  'ㅛ': { en: 'yo', zh: 'yo — 像"哟"', ja: 'yo — 「よ」の音', ko: 'ㅛ' },
  'ㅜ': { en: 'u', zh: 'u — 像"乌"', ja: 'u — 「う」の音', ko: 'ㅜ' },
  'ㅠ': { en: 'yu', zh: 'yu — 像"鱼"', ja: 'yu — 「ゆ」の音', ko: 'ㅠ' },
  'ㅡ': { en: 'eu', zh: 'eu — 扁嘴"呃"', ja: 'eu — 口を横に引く「う」', ko: 'ㅡ' },
  'ㅣ': { en: 'i', zh: 'i — 像"衣"', ja: 'i — 「い」の音', ko: 'ㅣ' },
};
