...
const CHAR_ROMANIZATIONS: Record<string, Record<string, string>> = {
  // Consonants
  'ㄱ': { en: 'g/k', zh: '像"哥"的声母', ko: 'ㄱ', ja: '「が」の子音' },
  'ㄴ': { en: 'n', zh: '像"呢"的声母', ko: 'ㄴ', ja: '「な」の子音' },
  'ㄷ': { en: 'd/t', zh: '像"的"的声母', ko: 'ㄷ', ja: '「だ」の子音' },
  'ㄹ': { en: 'r/l', zh: '像"了"的声母', ko: 'ㄹ', ja: '「ら」の子音' },
  'ㅁ': { en: 'm', zh: '像"么"的声母', ko: 'ㅁ', ja: '「ま」の子音' },
  'ㅂ': { en: 'b/p', zh: '像"八"的声母', ko: 'ㅂ', ja: '「ば」の子音' },
  'ㅅ': { en: 's', zh: '像"四"的声母', ko: 'ㅅ', ja: '「さ」の子音' },
  'ㅇ': { en: 'ng', zh: '像"嗯"的鼻音', ko: 'ㅇ', ja: '「ん」の音' },
  'ㅈ': { en: 'j', zh: '像"吉"的声母', ko: 'ㅈ', ja: '「じゃ」の子音' },
  'ㅊ': { en: 'ch', zh: '像"吃"的声母', ko: 'ㅊ', ja: '「ちゃ」の子音' },
  'ㅋ': { en: 'k', zh: '像"可"的声母(送气)', ko: 'ㅋ', ja: '「か」の子音(有気)' },
  'ㅌ': { en: 't', zh: '像"他"的声母(送气)', ko: 'ㅌ', ja: '「た」の子音(有気)' },
  'ㅍ': { en: 'p', zh: '像"怕"的声母(送气)', ko: 'ㅍ', ja: '「ぱ」の子音(有気)' },
  'ㅎ': { en: 'h', zh: '像"哈"的声母', ko: 'ㅎ', ja: '「は」の子音' },
  // Vowels
  'ㅏ': { en: 'a', zh: '像"啊"', ko: 'ㅏ', ja: '「あ」の音' },
  'ㅑ': { en: 'ya', zh: '像"呀"', ko: 'ㅑ', ja: '「や」の音' },
  'ㅓ': { en: 'eo', zh: '像"哦"(嘴稍开)', ko: 'ㅓ', ja: '「お」に近い音' },
  'ㅕ': { en: 'yeo', zh: '像"哟"(嘴稍开)', ko: 'ㅕ', ja: '「よ」に近い音' },
  'ㅗ': { en: 'o', zh: '像"喔"(嘴圆)', ko: 'ㅗ', ja: '「お」の音(唇丸め)' },
  'ㅛ': { en: 'yo', zh: '像"哟"(嘴圆)', ko: 'ㅛ', ja: '「よ」の音(唇丸め)' },
  'ㅜ': { en: 'u', zh: '像"乌"', ko: 'ㅜ', ja: '「う」の音' },
  'ㅠ': { en: 'yu', zh: '像"鱼"', ko: 'ㅠ', ja: '「ゆ」の音' },
  'ㅡ': { en: 'eu', zh: '扁嘴"呃"', ko: 'ㅡ', ja: '口を横に引く「う」' },
  'ㅣ': { en: 'i', zh: '像"衣"', ko: 'ㅣ', ja: '「い」の音' },
};
