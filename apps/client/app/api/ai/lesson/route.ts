...
const CHAR_ROMANIZATIONS: Record<string, Record<string, string>> = {
  // Consonants
  'ㄱ': { en: 'g/k', zh: 'g — 像"哥"的声母', ko: 'ㄱ', ja: 'g — 「が」の子音' },
  'ㄴ': { en: 'n', zh: 'n — 像"呢"的声母', ko: 'ㄴ', ja: 'n — 「な」の子音' },
  'ㄷ': { en: 'd/t', zh: 'd — 像"的"的声母', ko: 'ㄷ', ja: 'd — 「だ」の子音' },
  'ㄹ': { en: 'r/l', zh: 'r/l — 像"了"的声母', ko: 'ㄹ', ja: 'r/l — 「ら」の子音' },
  'ㅁ': { en: 'm', zh: 'm — 像"么"的声母', ko: 'ㅁ', ja: 'm — 「ま」の子音' },
  'ㅂ': { en: 'b/p', zh: 'b/p — 像"八"的声母', ko: 'ㅂ', ja: 'b/p — 「ば」の子音' },
  'ㅅ': { en: 's', zh: 's — 像"四"的声母', ko: 'ㅅ', ja: 's — 「さ」の子音' },
  'ㅇ': { en: 'ng', zh: 'ng — 像"嗯"的鼻音', ko: 'ㅇ', ja: 'ng — 「ん」の音' },
  'ㅈ': { en: 'j', zh: 'j — 像"吉"的声母', ko: 'ㅈ', ja: 'j — 「じゃ」の子音' },
  'ㅊ': { en: 'ch', zh: 'ch — 像"吃"的声母', ko: 'ㅊ', ja: 'ch — 「ちゃ」の子音' },
  'ㅋ': { en: 'k', zh: 'k — 像"可"的声母', ko: 'ㅋ', ja: 'k — 「か」の子音' },
  'ㅌ': { en: 't', zh: 't — 像"他"的声母', ko: 'ㅌ', ja: 't — 「た」の子音' },
  'ㅍ': { en: 'p', zh: 'p — 像"怕"的声母', ko: 'ㅍ', ja: 'p — 「ぱ」の子音' },
  'ㅎ': { en: 'h', zh: 'h — 像"哈"的声母', ko: 'ㅎ', ja: 'h — 「は」の子音' },
  // Vowels
  'ㅏ': { en: 'a', zh: 'a — 像"啊"', ko: 'ㅏ', ja: 'a — 「あ」の音' },
  'ㅑ': { en: 'ya', zh: 'ya — 像"呀"', ko: 'ㅑ', ja: 'ya — 「や」の音' },
  'ㅓ': { en: 'eo', zh: 'eo — 像"哦"', ko: 'ㅓ', ja: 'eo — 「お」に近い音' },
  'ㅕ': { en: 'yeo', zh: 'yeo — 像"哟"', ko: 'ㅕ', ja: 'yeo — 「よ」に近い音' },
  'ㅗ': { en: 'o', zh: 'o — 像"喔"', ko: 'ㅗ', ja: 'o — 「お」の音' },
  'ㅛ': { en: 'yo', zh: 'yo — 像"哟"', ko: 'ㅛ', ja: 'yo — 「よ」の音' },
  'ㅜ': { en: 'u', zh: 'u — 像"乌"', ko: 'ㅜ', ja: 'u — 「う」の音' },
  'ㅠ': { en: 'yu', zh: 'yu — 像"鱼"', ko: 'ㅠ', ja: 'yu — 「ゆ」の音' },
  'ㅡ': { en: 'eu', zh: 'eu — 扁嘴"呃"', ko: 'ㅡ', ja: 'eu — 口を横に引く「う」' },
  'ㅣ': { en: 'i', zh: 'i — 像"衣"', ko: 'ㅣ', ja: 'i — 「い」の音' },
};
